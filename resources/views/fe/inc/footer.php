...
<div class="footer-area">
                    ...
                    <div class="row flex-sm-row-reverse">
                        <div class="col-md-6 text-end">
                            <div class="payment-link">
                                <img src="<?=assetss?>assetsUser/images/icons/payment.png" alt="">
                            </div>
                        </div>
                            ...
                            <div class="swiper-container gallery-top mb-20px">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="<?=assetss?>assetsUser/images/product-image/1.jpg"
                                            alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="<?=assetss?>assetsUser/images/product-image/2.jpg"
                                            alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="<?=assetss?>assetsUser/images/product-image/3.jpg"
                                            alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="<?=assetss?>assetsUser/images/product-image/4.jpg"
                                            alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="<?=assetss?>assetsUser/images/product-image/5.jpg"
                                            alt="">
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Vendor JS -->
    <!-- <script src="<?=assetss?>assetsUser/js/vendor/jquery-3.6.0.min.js"></script>
    <script src="<?=assetss?>assetsUser/js/vendor/popper.min.js"></script>
    <script src="<?=assetss?>assetsUser/js/vendor/bootstrap.min.js"></script>
    <script src="<?=assetss?>assetsUser/js/vendor/jquery-migrate-3.3.2.min.js"></script>
    <script src="<?=assetss?>assetsUser/js/vendor/modernizr-3.11.2.min.js"></script> -->

    <!--Plugins JS-->
    <!-- <script src="<?=assetss?>assetsUser/js/plugins/swiper-bundle.min.js"></script>
    <script src="<?=assetss?>assetsUser/js/plugins/jquery-ui.min.js"></script>
    <script src="<?=assetss?>assetsUser/js/plugins/jquery.nice-select.min.js"></script>
    <script src="<?=assetss?>assetsUser/js/plugins/countdown.js"></script>
    <script src="<?=assetss?>assetsUser/js/plugins/scrollup.js"></script>
    <script src="<?=assetss?>assetsUser/js/plugins/jquery.waypoints.js"></script>
    <script src="<?=assetss?>assetsUser/js/plugins/jquery.lineProgressbar.js"></script>
    <script src="<?=assetss?>assetsUser/js/plugins/jquery.zoom.min.js"></script>
    <script src="<?=assetss?>assetsUser/js/plugins/venobox.min.js"></script>
    ...
    <!-- Main Js -->
    <script src="<?=assetss?>assetsUser/js/main.js"></script>
</body>


<!-- Mirrored from htmldemo.hasthemes.com/furns/furns/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Feb 2024 07:43:28 GMT -->
