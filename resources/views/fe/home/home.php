        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a class='image' href='single-product.html'><img src="<?=assetss?>assetsUser/images/product-image/1.jpg"
                    ...
                    <li>
                        <a class='image' href='single-product.html'><img src="<?=assetss?>assetsUser/images/product-image/2.jpg"
                                alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a class='image' href='single-product.html'><img src="<?=assetss?>assetsUser/images/product-image/3.jpg"
                                alt="Cart product Image"></a>
                        <div class="content">
                ...
                <div class="col-md-12 text-center mb-40px" data-aos="fade-up" data-aos-delay="200">
                    <ul class="product-tab-nav nav justify-content-center">
                        ...
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                href="#tab-product-best-sellers">Sản phẩn giảm giá</a></li>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            ...
                                            <div class="actions">
                                                <a class='action wishlist' href='wishlist.html' title='Wishlist'><i
                                                        class="icon-heart"></i></a>
                                                <a href="#" class="action quickview" data-link-action="quickview"
                                                    title="Quick view" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal"><i
                                                        class="icon-size-fullscreen"></i></a>
                                                <a class='action compare' href='compare.html' title='Compare'><i
                                                        class="icon-refresh"></i></a>

                                                <button class='action compare' href='' title='Add To Cart'
                                                    class=" add-to-cart"><i
                                        ...
                                        <div class="content">
                                            <h5 class="title"><a href=''><?=$value['name']?> </a>
                                            </h5>
                                            <span class="price">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a class='image' href='shop-left-sidebar.html'>
                                                ...
                                                <img class="hover-image" src="<?=assetss?>assetsUser/images/product-image/4.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="sale">-10%</span>
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a class='image' href='shop-left-sidebar.html'>
                                                ...
                                                <img class="hover-image" src="<?=assetss?>assetsUser/images/product-image/6.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a class='image' href='shop-left-sidebar.html'>
                                                ...
                                                <img class="hover-image" src="<?=assetss?>assetsUser/images/product-image/8.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a class='image' href='shop-left-sidebar.html'>
                                                ...
                                                <img class="hover-image" src="<?=assetss?>assetsUser/images/product-image/10.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a class='image' href='shop-left-sidebar.html'>
                                                ...
                                                <img class="hover-image" src="<?=assetss?>assetsUser/images/product-image/12.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                            </span>
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a class='image' href='shop-left-sidebar.html'>
                                                ...
                                                <img class="hover-image" src="<?=assetss?>assetsUser/images/product-image/14.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                            </span>
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a class='image' href='shop-left-sidebar.html'>
                                                ...
                                                <img class="hover-image" src="<?=assetss?>assetsUser/images/product-image/16.jpg"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                ...
                <div class="swiper-wrapper">
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href='blog-single-left-sidebar.html'><img src="<?=assetss?>assetsUser/images/blog-image/1.jpg"
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href='blog-single-left-sidebar.html'><img src="<?=assetss?>assetsUser/images/blog-image/2.jpg"
                                    class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href='blog-single-left-sidebar.html'><img src="<?=assetss?>assetsUser/images/blog-image/3.jpg"
                                    class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href='blog-single-left-sidebar.html'><img src="<?=assetss?>assetsUser/images/blog-image/4.jpg"
                                    class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                    <div class="insta-wrapper">
                        <a href="https://www.instagram.com/" target="_blank"><img class="w-100"
                                src="<?=assetss?>assetsUser/images/instragram-image/1.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="400">
                    <div class="insta-wrapper">
                        <a href="https://www.instagram.com/" target="_blank"><img class="w-100"
                                src="<?=assetss?>assetsUser/images/instragram-image/2.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-xs-30px" data-aos="fade-up" data-aos-delay="600">
                    <div class="insta-wrapper">
                        <a href="https://www.instagram.com/" target="_blank"><img class="w-100"
                                src="<?=assetss?>assetsUser/images/instragram-image/3.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 " data-aos="fade-up" data-aos-delay="800">
                    <div class="insta-wrapper">
                        <a href="https://www.instagram.com/" target="_blank"><img class="w-100"
                                src="<?=assetss?>assetsUser/images/instragram-image/4.png" alt="">
