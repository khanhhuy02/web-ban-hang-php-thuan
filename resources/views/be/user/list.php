                                ...
                                <tbody>
                                    ...
                                    foreach ($list as $key => $item) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= $item['role'] == 1 ? "Quản trị viên" : "Khách hàng" ?>
                                            </td>
                                            <td>
                                                <a href="<?= ROOT_URL ?><?=administrators?>/edit/user/<?= $item['id'] ?>" class="status_btn">sữa</a>
                                                <a href="<?= ROOT_URL ?><?=administrators?>/delete/user/<?= $item['id'] ?>" class="status_btn" style="background-color: red;">Xóa</a> <a href="../thong-tin/addInformation.php" class="status_btn" style="background-color: blue;">update nội dung</a>
                                            </td>
                                        </tr><?php } ?>
                                </tbody>
